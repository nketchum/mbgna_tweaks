 ...
 *     "add-form" = "/admin/content/resource/add/{resource_type}",
 *     "add-page" = "/admin/content/resource/add",
 *     "canonical" = "/resource/{resource}",
 *     "edit-form" = "/resource/{resource}/edit",
 *     "delete-form" = "/resource/{resource}/delete",
 *     "version-history" = "/admin/content/resource/{resource}/revisions",
 *     "revision" = "/admin/content/resource/{resource}/revisions/{resource_revision}/view",
 *     "revision_revert" = "/admin/content/resource/{resource}/revisions/{resource_revision}/revert",
 *     "revision_delete" = "/admin/content/resource/{resource}/revisions/{resource_revision}/delete",
 *   },
